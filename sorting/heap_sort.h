...
inline std::size_t get_largest_element_pos(const Iterator begin, const std::size_t root_pos, const std::size_t heap_size){
...
template <typename Iterator>
inline void max_heapify(Iterator begin, std::size_t root_pos, std::size_t heap_size){
	std::size_t largest_elem_pos = get_largest_element_pos(begin, root_pos, heap_size);
	if(largest_elem_pos == root_pos)
		return;
