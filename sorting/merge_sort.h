 ...
 *
 * @details    Merge sort funcion takes begin and end iterators of any container
 and sorts it based on merge sort algorithm. In Merge sort the algorithm
 recursively divides the array into two arrays of half size until arraz of
 single elements and then the array  are merged pairwise to form a sorted array.
 *
